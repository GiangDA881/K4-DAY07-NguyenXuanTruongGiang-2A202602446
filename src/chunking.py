...
class SentenceChunker:
    ...
    def chunk(self, text: str) -> list[str]:
        ...
        # Using lookbehind so punctuation stays with the sentence
...
class RecursiveChunker:
    ...
    def _split(self, current_text: str, remaining_separators: list[str]) -> list[str]:
        ...
        # Base case: no more separators to try, split by fixed character slices
        ...
        for split in splits:
            ...
            if split_len > self.chunk_size:
                ...
                additional_len = split_len + (len(sep) if current_chunk else 0)
                if current_length + additional_len <= self.chunk_size:
